...
export const scheduleItems: ScheduleItem[] = [
  ...
  { 
    ...
    type: 'session', 
    title: 'Session 1', 
    speakerIds: [1] // Example: Ulrik Aabye-Hansen
  },
  { 
    time: '10:15 - 10:40', 
    type: 'sponsor', 
    title: 'Sponsor Session 1',
    speakerIds: [6, 8] // Example: Harrison & Henry (Fleet)
  },
  ...
  { 
    ...
    type: 'session', 
    title: 'Session 2', 
    speakerIds: [2, 10] // Example: Armin & Rob
  },
  { 
    time: '11:55 - 12:20', 
    type: 'sponsor', 
    title: 'Sponsor Session 2',
    speakerIds: [9] // Example: David Starr (Workbrew)
  },
  ...
  { 
    ...
    type: 'session', 
    title: 'Session 3',
    speakerIds: [4] // Example: Guillaume Gète
  },
  { 
    time: '14:05 - 14:50', 
    type: 'session', 
    title: 'Session 4',
    speakerIds: [7] // Example: Alexandra Smith
  },
  ...
  { 
    ...
    speakerIds: [3] // Example: Weldon Dodd (Iru)
  },
  { 
    time: '15:45 - 16:30', 
    type: 'session', 
    title: 'Session 5',
    speakerIds: [5] // Example: Rachelle Noel
  },
  { 
    time: '16:30 - 16:55', 
    type: 'sponsor', 
